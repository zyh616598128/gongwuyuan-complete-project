...
echo "=== Gongwuyuan Application Integration Test (Fixed) ==="
echo ""
...
test_auth_api "/api/users/profile" "PUT" "{\"phone\":\"13800138000\",\"nickname\":\"Updated User\"}" "$TOKEN" "200" "Update User Profile"
...
echo ""
echo "=== Phase 5: Exam Management ==="

# Test getting exam history
test_auth_api "/api/exams/history" "GET" "" "$TOKEN" "200" "Get Exam History"

# Test creating an exam
test_auth_api "/api/exams" "POST" "{\"subjectId\":1,\"title\":\"Integration Test Exam\",\"durationMinutes\":60,\"questionCount\":10}" "$TOKEN" "200" "Create Exam"
...
test_auth_api "/api/wrong-questions" "POST" "{\"questionId\":1,\"notes\":\"Need to review this concept\"}" "$TOKEN" "200" "Add Wrong Question"

echo ""
echo "=== Phase 7: Frontend Availability ==="
